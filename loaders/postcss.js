  ...
  return {
    plugins: [
      new MiniCssExtractPlugin({
        filename: 'dist/'+name+'/[name].css?[contenthash]/' + Math.floor((Math.random() * 100000) + 1),
        chunkFilename: 'dist/'+name+'/module/module.[name].css?[contenthash]/' + Math.floor((Math.random() * 100000) + 1),
